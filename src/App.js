...
import HeaderNavbar from './Nav-Bar.js'
import Headerpage from './Header.js'
import ServiceSection from './servicesection.js'
import './servicesection.css'
import './cities-section.css'
import Companypres from './compnay-presentation.js'
import AboutDocplannerfirst from './about-docplanner-first.js'
import AboutDocplannersecond from './about-docplanner-second.js'
import CitiesSection from './cities-section.js'
import FooterFirst from './Footer-First.js'
import FooterSecond from './Footer-Second.js'

const navcont = [
  {
    class:"navkey navkeydiff",
      name:'About Us',
      link:'https://About-Us.com/',
  },
  {
    class:"navkey",
      name: 'Career',
      link:'https://career.com/',
  },
  {
    class:"navkey",
      name:'Departments',
...
const  Pagetitlecont= [{
  ...
  parg1:"We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and that's why we are always next to them: to help them find the best possible care. Anytime, anywhere.",
  parg2:"We also help doctors to better manage their practice and build their online reputation. With our integrated end-to-end solution, doctors are able not only to improve their online presence, but also to devote their time to what really matters: their patients."
}]

const servcont=[{
  title:'For patients',
  parag:'Find a doctor, book a visit and solve any health-related doubt',
  put:[{countryname:'choose country',},{countryname:'UK',},{countryname:'USA',},{countryname:'Italie',}],
  src:'https://www.docplanner.com/img/screen-marketplace@2x.png',
  alt:"img-service-section",
},
{
  title:'For doctors',
...
const aboutdocfirst=[
  {
    titlep1:"The world's",
    titlep2:"biggest healthcare platform",
    parag:"We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.",
    img:"https://raw.githubusercontent.com/AhmedKn/docplanner/master/logo.png",
    cards:[
      {
        class:"about-docplanner-card-bot",
      ...
      {
        class:"about-docplanner-card-top",
...
<div>
    ...
    <div className="header-nav">
        <img className='doc-logo-nav' src='https://www.docplanner.com/img/logo-default-group-en.svg?v=1' height="33" width="268" />
    <ul className="navbar">
    <HeaderNavbar navcontent={navcont}/>
    </ul>
   </div>


   <Headerpage Pagetitlecontent={Pagetitlecont} />
   
     <div className="serv-section">
     <ServiceSection servcontent={servcont}/>
     </div>
   
     <Companypres companypresentation={comppres}/>
     <AboutDocplannerfirst aboutdocplannerfirst={aboutdocfirst} />
     <AboutDocplannersecond />
     <div className="cities-section">
     <CitiesSection citiessection={citiessec} />
     </div>
     <FooterFirst />
     <FooterSecond />
 </div>
